...
const airQualityServices = {
  intro:
    "Your HVAC system does more than heat and cool—it's also your home's respiratory system. If you're dealing with allergies, dry skin in winter, or stuffy rooms, the solution might be improving your air quality.",
  solutions: [
    {
      title: "Air Purification",
      description:
        "Whole-home air purifiers that work with your ductwork to filter particles and neutralize pathogens. More effective than portable units.",
    },
    {
      title: "Humidity Control",
      description:
        "Humidifiers combat dry winter air. Dehumidifiers reduce excess moisture that leads to mold growth and musty odors.",
    },
    {
      title: "Ventilation",
      description:
        "Fresh air exchangers bring in filtered outdoor air while exhausting stale indoor air—without losing your heated or cooled air.",
    },
  ],
};
  ...
  process: [
    {
      ...
      description: "Manual J calculations determine exactly how much heating and cooling capacity your home needs",
    },
    {
      step: "Equipment Selection",
      description: "We match equipment to your specific requirements, not a rule-of-thumb guess",
    },
...
const whyChooseUs = [
  {
    ...
    description:
      "We focus on systems that actually perform—and save you money month after month. Energy efficiency isn't a buzzword to us; it's how we evaluate every recommendation.",
  },
  {
    title: "Proper Sizing, Every Time",
    description:
      "An oversized system wastes energy and wears out faster. We do the math using Manual J load calculations rather than guessing based on square footage.",
  },
  {
    title: "Our Own Installation Crews",
    description:
      "We don't subcontract our installations. The same team that designs your system installs it. This means accountability and consistency.",
  },
];
...
const testimonials = [
  {
    quote:
      "I can't say enough good things about Truficient. They went above and beyond when our AC broke down in the middle of a heat wave.",
    author: "T.A. Smith",
  },
  {
  ...
  {
    quote:
      "I have never had a better purchasing experience in my entire life. Eric and his staff deliver more than what is possible.",
    author: "Gay R.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-primary text-primary-foreground py-20 lg:py-28">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Complete Home Comfort Solutions</h1>
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto mb-8">
              Energy-efficient heating, cooling, and air quality services for Dallas-Fort Worth homeowners. Licensed,
              insured, and HERS-certified.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              When Texas heat hits triple digits, your AC isn't a luxury—it's essential. We diagnose problems fast,
              recommend honest solutions, and install energy-efficient systems sized correctly for your home.
            </p>
          </motion.div>
            ...
            >
              <Card className="h-full bg-card">
                <CardContent className="p-8">
                  ...
                  <Link
                    to="/hvac-estimate"
                    onClick={() => handleTrackClick("Repair vs Replace Calculator", "/hvac-estimate")}
                  >
      ...
      <section id="heating" className="py-16 lg:py-24 bg-background scroll-mt-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Dallas winters are unpredictable. One week it's 70°, the next we're dealing with ice storms. Your heating
              system needs to be ready—and efficient enough that you're not dreading the gas bill.
            </p>
          </motion.div>
            ...
            >
              <Card className="h-full bg-card">
                <CardContent className="p-8">
                  ...
                  <Link
                    to="/hvac-estimate"
                    onClick={() => handleTrackClick("Heat Pump Savings Calculator", "/hvac-estimate")}
                  >
                    <Button className="w-full bg-secondary hover:bg-gold-dark text-secondary-foreground">
      ...
      <section id="air-quality" className="py-16 lg:py-24 bg-muted scroll-mt-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">{airQualityServices.intro}</p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">{designServices.body}</p>
            </div>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mt-6 p-4 bg-muted rounded-lg">
                    <p className="text-sm text-muted-foreground">
                      <strong className="text-foreground">HERS Certification:</strong> Our team includes HERS-certified
                      professionals who can evaluate and verify your home's energy performance.
                    </p>
                  </div>
                </CardContent>
              </Card>
      ...
      <section id="estimate" className="py-16 lg:py-24 bg-background scroll-mt-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Ready to Improve Your Home Comfort?</h2>
